...
#     try:
#         while True:
#             coordinate_data = simulate_circular_movement()
#             topic = "coordinates"
#             client.publish(topic, json.dumps(coordinate_data))
#             print(f"Published: {coordinate_data}")
#             time.sleep(0.1)  # Update every update_interval seconds
